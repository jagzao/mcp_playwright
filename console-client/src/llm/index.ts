...
// Qwen client (primary)
clients.set('qwen', new QwenClient(config.llm.qwenEndpoint));

// Ollama clients (fallback)
clients.set('deepseek', new OllamaClient('deepseek-coder:6.7b', config.llm.ollamaEndpoint));
clients.set('codellama', new OllamaClient('codellama:7b', config.llm.ollamaEndpoint));
